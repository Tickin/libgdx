...
public class SpawnInfluencer extends Influencer {
	...
	public void activateParticles (int startIndex, int count) {
		for (int i = startIndex * positionChannel.strideSize, c = i + count * positionChannel.strideSize; i < c; i += positionChannel.strideSize) {
			...
			positionChannel.data[i + ParticleChannels.XOffset] = TMP_V1.getX();
			positionChannel.data[i + ParticleChannels.YOffset] = TMP_V1.getY();
			positionChannel.data[i + ParticleChannels.ZOffset] = TMP_V1.getZ();
		}
	}
