...
public class FrustumCullingTest extends BaseBulletTest {
	...
	public static Model createFrustumModel (final Vector3... p) {
		...
		mpb.vertex(p[0].getX(), p[0].getY(), p[0].getZ(), 0, 0, 1, p[1].getX(), p[1].getY(), p[1].getZ(), 0, 0, 1, p[2].getX(),
			p[2].getY(), p[2].getZ(), 0, 0, 1, p[3].getX(), p[3].getY(), p[3].getZ(), 0, 0,
			1, // near
			p[4].getX(), p[4].getY(), p[4].getZ(), 0, 0, -1, p[5].getX(), p[5].getY(), p[5].getZ(), 0, 0, -1, p[6].getX(), p[6].getY(), p[6].getZ(), 0, 0, -1, p[7].getX(), p[7].getY(),
			p[7].getZ(), 0, 0, -1);
